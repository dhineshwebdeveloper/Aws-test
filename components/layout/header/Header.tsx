...
import logo from "@/public/img/logo/amohaa_go.png";
import logoBlack from "@/public/img/logo/amohaa_go_png.png";
                ...
                <div className="header-left">
                  <div className="logo">
                    <Link href="/" className="header-logo">
                      <Image width="230" src={logo} alt="logo-img" priority />
                    </Link>
                    <Link href="/" className="header-logo-2">
                      <Image width="200" src={logoBlack} alt="logo-img" priority />
                    </Link>
                  </div>
                </div>
                              ...
                              <li className="border-none">
                                <div className="homemenu-items">
                                  ...
                                  <div className="homemenu-list">
                                    ...
                                    <div className="content">
                                      <h6>
                                        <Link href="https://www.secureserver.net/domains/bulk-domain-search?plid=596796">
                                        Bulk Registration
                                        </Link>
                                      </h6>
                                  ...
                                  <div className="homemenu-list mb-0">
                                    ...
                                    <div className="content">
                                      <h6>
                                        <Link href="https://www.secureserver.net/domains/bulk-domain-transfer.aspx?plid=596796">
                                        Bulk Transfer
                                        </Link>
                                      </h6>
