...
const NewsGrid = () => {
  ...
  const slug = params?.categories; // Ensure `categories` is accessed safely

  // Find the post matching the category slug
  const post = postdetails.find((item) => item.category === slug);
            ...
            >
              <div className="news-card-items mt-0 box-shadow">
                <div className="news-image">
                  <img
                    src={post.image} // Default image if no image is provided
                    alt="news-img"
                    width={400}
                    height={300}
                ...
                <div className="news-content">
                  ...
                  <div className="author-items">
                    ...
                    <Link href={`/${post.ID}`}  key={post.ID} className="link-btn">
